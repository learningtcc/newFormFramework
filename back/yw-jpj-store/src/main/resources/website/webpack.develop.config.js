...
module.exports = {
  ...
  entry: [
    ...
    'webpack-dev-server/client?http://localhost:8068',
  ...
  devServer: {
    ...
    proxy: [
      {
        context: ['/user', '/dict', '/authority', '/role', '/common', '/api', '/cms', '/offerVoucher', '/thematicActivities', '/interactive', '/advertising', '/commodity', '/store', '/statistical', '/lease', '/order'],
        target: 'http://192.168.11.113:6881/'
        // secure: false,
        // changeOrigin: true
      }
    ]
