...
public class OrderInfo extends SystemModel{
     ...
     * 优惠金额
     */
    @SerializedName("offer_voucher_price")
    private Double offerVoucherPrice;
    ...
    public Double getOfferVoucherPrice() {
        return offerVoucherPrice;
    }

    public void setOfferVoucherPrice(Double offerVoucherPrice) {
        this.offerVoucherPrice = offerVoucherPrice;
    }
